...
import cosmic.textures.handlers.prisons.BoosterHandler;
import cosmic.textures.handlers.prisons.ChargeOrbHandler;
import cosmic.textures.handlers.prisons.PageHandler;
import cosmic.textures.handlers.prisons.ContrabandHandler;
import cosmic.textures.handlers.prisons.PrisonsDustHandler;
import cosmic.textures.handlers.prisons.PrisonsMysteryChestHandler;
import cosmic.textures.handlers.prisons.PrisonsEnchantBookHandler;
import cosmic.textures.handlers.prisons.PrisonsShardHandler;
...
public class CosmicTexturesClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ItemModelCallback.EVENT.register(stack -> {
            ...
            // Temporarily made "Always True" - can revert to being server-specific if data overlaps between sky and prisons but unlikely
            if (server.contains("cosmicsky") || (1+1==2)) {
                ...
                if (stack.contains(DataComponentTypes.CUSTOM_DATA)) {
                    ...
                    // Support cosmicItem and persistentItem
                    ...
                    if (!cosmicItemType.isEmpty()) {
                        handler = HANDLERS.get(cosmicItemType);
                    }
            ...
            if (stack.contains(DataComponentTypes.CUSTOM_DATA)) {
                ...
                // Contrabands
                if (customItemID.contains("contraband_")) return ContrabandHandler.resolve(customItemID);
